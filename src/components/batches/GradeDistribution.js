    ...
    return(
      <div>
        ...
        <div className="flex-container">
          <div className="barRed" style={styleRed}>{Math.round(redRatio*100)}%</div>
          <div className="barYellow" style={styleYellow}>{Math.round(yellowRatio*100)}%</div>
          <div className="barGreen" style={styleGreen}>{Math.round(greenRatio*100)}%</div>
        </div>
      </div>
    )
  }
